...
enum
{
    ...
    MINIZ_EXPORT tdefl_status tdefl_compress_buffer(const tdefl_compressor *d, const void *pIn_buf, size_t in_buf_size, tdefl_flush flush);

    MINIZ_EXPORT tdefl_status tdefl_get_prev_return_status(const tdefl_compressor *d);
    MINIZ_EXPORT mz_uint32 tdefl_get_adler32(const tdefl_compressor *d);
